...
export default function ExploreJobTeacher(props) {
        ...
        useEffect(() => {
                ...
                /api/jobsteacher?title=${title}&tags=${tags}
        ...
        console.log(title);
        history.push(`/explore-jobs-teacher/title/${Title || 'all' }/tags/${ TAGS.length > 0 ? TAGS.toString().split(',').join('+') : 'all' }`)
        ...
        return (
          ...
          <Row className='top' >
            ...
            <br/><p style={{textAlign:'right' , paddingRight:'20px' , fontWeight:'bolder' , color:'gray' }} >{TotalGigs + ' Teaching Jobs Found' }</p><br/>
